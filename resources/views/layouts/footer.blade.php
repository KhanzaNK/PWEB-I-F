<footer class="footer-dark mt-5">
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                ...
                <p class="footer-text">
                    Platform pengelolaan sampah yang membantu masyarakat untuk menjual
                    sampah dan berkontribusi pada lingkungan yang lebih bersih.
                </p>
            </div>
    ...
    <div class="footer-bottom text-center py-3">
        © {{ date('Y') }} EcoWaste. Semua hak dilindungi.
    </div>
</footer>
